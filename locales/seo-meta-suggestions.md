SEO — Suggestions de titres et meta descriptions
...
- Meta description: Consultez les disponibilités et réservez votre séjour au Cottage 13, domaine Les cottages du lac. Calendrier mis à jour et lien direct vers l'annonce. Meilleures dates pour profiter du lac et de la plage.

2) Reservation (EN)
- Title: Booking — Cottage 13 (Parentis-en-Born, Biscarrosse, Landes)
- Meta description: Check availability and book Cottage 13, domain Les cottages du lac. Updated calendar and direct booking link. Ideal location for lake and beach visits in the Landes.

3) Contact (FR)
- Title: Contact — Cottage 13  (Parentis-en-Born, Biscarrosse, Landes)
- Meta description: Contactez-nous pour toute question sur votre séjour au Cottage 13 (Parentis-en-Born, Biscarrosse, Landes). Informations de réservation et assistance.

3) Contact (EN)
- Title: Contact — Cottage 13  (Parentis-en-Born, Biscarrosse, Landes)
- Meta description: Contact us for inquiries about your stay at Cottage 13 (Parentis-en-Born, Biscarrosse, Landes). Booking information and assistance.
...
- Les meta/tags ont été insérés directement dans `index.html` : canonical, `hreflang` pour les langues (fr/en/es/nl/de), meta description par défaut (FR) et un JSON-LD `LodgingBusiness` minimal.
- Le `sitemap.xml` est présent à la racine et prêt à être soumis à Google Search Console.

Veux-tu que j'ajoute un petit script pour mettre à jour dynamiquement la balise `meta[name=description]` et le `title` lors du changement de langue (recommandé si tu souhaites des descriptions spécifiques par langue) ?
